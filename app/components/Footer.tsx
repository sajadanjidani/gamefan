                    ...
                    <div className="h-7/10 flex flex-col">
                        ...
                        <div>
                            <ul className="grid grid-cols-2 grid-rows-2 gap-3 sm:flex mt-5 justify-center items-center text-center sm:text-left">
                                <li className="border-r-2 px-4 border-white hover:cursor-pointer hover:text-blue-400 md:text-base text-sm">Support</li>
                                <li className="sm:border-r-2 px-4 border-white hover:cursor-pointer hover:text-blue-400 md:text-base sm:text-sm text-xs">contact us</li>
                                <li className="border-r-2 px-4 border-white hover:cursor-pointer hover:text-blue-400 md:text-base text-sm">Terms and conditions of use</li>
                                <li className="px-4 hover:cursor-pointer hover:text-blue-400 md:text-base sm:text-sm text-xs">Frequently asked questions</li>
                            </ul>
                        </div>
                        ...
                        <div className="text-center">
                            <p className="text-xs">This is a practice project created by <a className="text-blue-400 hover:text-purple-400" href="https://github.com/sajadanjidani">me</a>.</p>
                            <p className="mt-2 text-xs">Create in 2026/7/28</p>
                        </div>
                    </div>
                </div>
            </footer>
