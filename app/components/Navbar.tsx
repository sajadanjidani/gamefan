  ...
  render() {
    return (
      <div className="mx-auto flex items-center justify-between h-15 md:mt-10 xl:container w-full px-5 md:px-3">
        ...
        <form
          id="Navbar-form"
          className="items-center px-4 py-2 bg-white/10 rounded-4xl overflow-hidden xl:w-70 lg:w-1/4 md:w-3/11 md:flex hidden"
        >
          <IoSearch className="size-5" />
          <input
            id="Navbar-input"
            className="outline-0 ml-3 xl:w-full lg:w-8/10 md:w-6/10"
            type="text"
            placeholder="Search ..."
          />
        </form>
          ...
          {this.state.menuStatus && (
            <div>
              <div className="fixed z-50 left-0 top-0 w-2/3 h-dvh bg-blue-950">
                ...
                <form
                  id="Navbar-form"
                  className="flex items-center mt-3 mx-3 px-4 py-2 bg-white/10 rounded-4xl overflow-hidden"
                >
                  <IoSearch className="size-5" />
                  <input
                    id="Navbar-input"
                    className="outline-0 ml-3 w-9/10"
                    type="text"
                    placeholder="Search ..."
                  />
                </form>
              ...
              <div
                className="fixed z-50 right-0 top-0 w-1/3 h-dvh bg-blue-900/30"
                onClick={this.menuHandler}
              ></div>
            </div>
          )}
